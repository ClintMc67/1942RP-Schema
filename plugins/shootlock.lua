...
concommand.Add("checkDoor", function(ply)
	local ray = ply:GetEyeTrace()
	print(ray.Entity)
end)

function PLUGIN:EntityTakeDamage(entity, dmgInfo)
	if (entity:GetClass() == "prop_door_rotating" or entity:GetClass() == "func_door_rotating" and (entity.nutNextBreach or 0) < CurTime()) then
