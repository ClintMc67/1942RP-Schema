...
local rankfaction = FACTION_GERMANS
...
ranks = {
  ...
  panzergrenadier = {
    {name = "Panzergrenadier", model = "models/kriegsyntax/germans/panzergrenadier/enlisted/schutze/playermodel.mdl"},
    {name = "Oberpanzergernadier", model = "models/kriegsyntax/germans/panzergrenadier/enlisted/oberschutze/playermodel.mdl"},
    {name = "Pzg Gefreiter", model = "models/kriegsyntax/germans/panzergrenadier/enlisted/gefreiter/playermodel.mdl"},
    {name = "Pzg Obergefreiter", model = "models/kriegsyntax/germans/panzergrenadier/enlisted/obergefreiter/playermodel.mdl"},
    {name = "Pzg Stabsgefreiter", model = "models/kriegsyntax/germans/panzergrenadier/enlisted/stabsgefreiter/playermodel.mdl"},

    {name = "Pzg Unteroffizier", model = "models/kriegsyntax/germans/panzergrenadier/ncos/unteroffizer/playermodel_2.mdl"},
    {name = "Pzg Unterfeldwebel", model = "models/kriegsyntax/germans/panzergrenadier/ncos/unterfeldwebel/playermodel_2.mdl"},
    {name = "Pzg Feldwebel", model = "models/kriegsyntax/germans/panzergrenadier/ncos/feldwebel/playermodel_2.mdl"},
    {name = "Pzg Oberfeldwebel", model = "models/kriegsyntax/germans/panzergrenadier/ncos/oberfeldwebel/playermodel_2.mdl"},
    {name = "Pzg Stabsfeldwebel", model = "models/kriegsyntax/germans/panzergrenadier/ncos/stabsfeldwebel/playermodel_2.mdl"},

    {name = "Pzg Leutnant", model = "models/kriegsyntax/germans/panzergrenadier/cos/leutnant/playermodel.mdl"},
    {name = "Pzg Oberleutnant", model = "models/kriegsyntax/germans/panzergrenadier/cos/oberleutnant/playermodel.mdl"},
    {name = "Pzg Hauptmann", model = "models/kriegsyntax/germans/panzergrenadier/cos/hauptmann/playermodel.mdl"},
    {name = "Pzg Major", model = "models/kriegsyntax/germans/panzergrenadier/cos/major/playermodel.mdl"},
    {name = "Pzg Oberstleutnant", model = "models/kriegsyntax/germans/panzergrenadier/cos/oberstleutnant/playermodel.mdl"},
    {name = "Pzg Oberst", model = "models/kriegsyntax/germans/panzergrenadier/cos/oberst/playermodel.mdl"},
  },
  gross = {
  ...
  nsdap = {
    {name = "Anwärter", model = "models/kriegsyntax/germans/nsdap/lowcommand/anwarter/playermodel.mdl"},
  ...
  sd = {
    ...
    {name = "SiPo Sturmmann", model = "models/kriegsyntax/germans/waffenss/enlisted/sturmmann/playermodel.mdl"},
    {name = "SiPo Rottenführer", model = "models/kriegsyntax/germans/waffenss/enlisted/rottenfuhrer/playermodel.mdl"},
	
	{name = "SD Unterscharführer", model = "models/kriegsyntax/germans/ss/sd/ncos/unterscharfuhrer/playermodel.mdl"},
    {name = "SD Scharführer", model = "models/kriegsyntax/germans/ss/sd/ncos/scharfuhrer/playermodel.mdl"},
    {name = "SD Oberscharführer", model = "models/kriegsyntax/germans/ss/sd/ncos/oberscharfuhrer/playermodel.mdl"},
    {name = "SD Hauptscharführer", model = "models/kriegsyntax/germans/ss/sd/ncos/hauptscharfuhrer/playermodel.mdl"},
    {name = "SD Sturmscharführer", model = "models/kriegsyntax/germans/ss/sd/ncos/stabsfeldwebel/playermodel.mdl"},

    {name = "SD Untersturmführer", model = "models/kriegsyntax/germans/ss/sd/cos/untersturmfuhrer/playermodel.mdl"},
    {name = "SD Obersturmführer", model = "models/kriegsyntax/germans/ss/sd/cos/obersturmfuhrer/playermodel.mdl"},
    {name = "SD Hauptsturmführer", model = "models/kriegsyntax/germans/ss/sd/cos/hauptsturmfuhrer/playermodel.mdl"},
    {name = "SD Sturmbannführer", model = "models/kriegsyntax/germans/ss/sd/cos/sturmbannfuhrer/playermodel.mdl"},
	{name = "SD Obersturmbannführer", model = "models/kriegsyntax/germans/ss/sd/cos/obersturmbannfuhrer/playermodel.mdl"},
    {name = "SD Standartenführer", model = "models/kriegsyntax/germans/ss/sd/cos/standartenfuhrer/playermodel.mdl"},
	{name = "SD Oberführer", model = "models/kriegsyntax/germans/ss/sd/cos/oberfuhrer/playermodel.mdl"},
  },
  korps = {
    {name = "Panzerschütze", model = "models/kriegsyntax/germans/wehrmacht/panzer/enlisted/schutze/playermodel.mdl"},
    {name = "Panzeroberschütze", model = "models/kriegsyntax/germans/wehrmacht/panzer/enlisted/oberschutze/playermodel.mdl"},
	...
	{name = "Pz Major", model = "models/kriegsyntax/germans/wehrmacht/cos/major/playermodel.mdl"},
  },
  ss = {
    {name = "SS Mann", model = "models/kriegsyntax/germans/ss/enlisted/schutze/playermodel.mdl"},
    {name = "SS Sturmmann", model = "models/kriegsyntax/germans/ss/enlisted/sturmmann/playermodel.mdl"},
    {name = "SS Rottenführer", model = "models/kriegsyntax/germans/ss/enlisted/rottenfuhrer/playermodel.mdl"},

    {name = "SS Unterscharführer", model = "models/kriegsyntax/germans/ss/ncos/unterscharfuhrer/playermodel_2.mdl"},
    {name = "SS Scharführer", model = "models/kriegsyntax/germans/ss/ncos/scharfuhrer/playermodel_2.mdl"},
    {name = "SS Oberscharführer", model = "models/kriegsyntax/germans/ss/ncos/oberscharfuhrer/playermodel_2.mdl"},
    {name = "SS Hauptscharführer", model = "models/kriegsyntax/germans/ss/ncos/hauptscharfuhrer/playermodel_2.mdl"},
    {name = "SS Sturmscharführer", model = "models/kriegsyntax/germans/ss/ncos/stabsscharfuhrer/playermodel_2.mdl"},

    {name = "SS Untersturmführer", model = "models/kriegsyntax/germans/ss/cos/untersturmfuhrer/playermodel.mdl"},
    {name = "SS Obersturmführer", model = "models/kriegsyntax/germans/ss/cos/obersturmfuhrer/playermodel.mdl"},
    {name = "SS Hauptsturmführer", model = "models/kriegsyntax/germans/ss/cos/hauptsturmfuhrer/playermodel.mdl"},
	{name = "SS Sturmbannführer", model = "models/kriegsyntax/germans/ss/cos/sturmbannfuhrer/playermodel.mdl"},
    {name = "SS Obersturmbannführer", model = "models/kriegsyntax/germans/ss/cos/obersturmbannfuhrer/playermodel.mdl"},
    {name = "SS Standartenführer", model = "models/kriegsyntax/germans/ss/cos/standartenfuhrer/playermodel.mdl"},
    {name = "SS Oberführer", model = "models/kriegsyntax/germans/ss/cos/oberfuhrer/playermodel.mdl"},
	{name = "SS Brigadeführer", model = ""},
	{name = "SS Gruppenführer", model = ""},
	{name = "SS Obergruppenführer", model = ""},
	{name = "SS Oberstgruppenführer", model = ""},
  },
  orpo = {
  ...
  leib = {
    {name = "LSS Mann", model = "models/kriegsyntax/germans/ss/lss/enlisted/schutze/playermodel.mdl"},
	{name = "LSS Obermann", model = "models/kriegsyntax/germans/ss/lss/enlisted/oberschutze/playermodel.mdl"},
    {name = "LSS Sturmmann", model = "models/kriegsyntax/germans/ss/lss/enlisted/sturmmann/playermodel.mdl"},
    {name = "LSS Rottenführer", model = "models/kriegsyntax/germans/ss/lss/enlisted/rottenfuhrer/playermodel.mdl"},
  },
  doctor = {
  ...
  waffen = {
    {name = "Waffen SS Schütze", model = "models/kriegsyntax/germans/waffenss_autumn/enlisted/schutze/playermodel.mdl"},
    {name = "Waffen SS Oberschütze", model = "models/kriegsyntax/germans/waffenss_autumn/enlisted/oberschutze/playermodel.mdl"},
    {name = "Waffen SS Sturmmann", model = "models/kriegsyntax/germans/waffenss_autumn/enlisted/sturmmann/playermodel.mdl"},
    {name = "Waffen SS Rottenführer", model = "models/kriegsyntax/germans/waffenss_autumn/enlisted/rottenfuhrer/playermodel.mdl"},

    {name = "Waffen SS Unterscharführer", model = "models/kriegsyntax/germans/waffenss_autumn/ncos/unterscharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Scharführer", model = "models/kriegsyntax/germans/waffenss_autumn/ncos/scharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Oberscharführer", model = "models/kriegsyntax/germans/waffenss_autumn/ncos/oberscharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Hauptscharführer", model = "models/kriegsyntax/germans/waffenss_autumn/ncos/hauptscharfuhrer/playermodel_2.mdl"},
    {name = "Waffen SS Sturmscharführer", model = "models/kriegsyntax/germans/waffenss_autumn/ncos/stabsscharfuhrer/playermodel_2.mdl"},

    {name = "Waffen SS Untersturmführer", model = "models/kriegsyntax/germans/waffenss_autumn/cos/untersturmfuhrer/playermodel.mdl"},
    {name = "Waffen SS Obersturmführer", model = "models/kriegsyntax/germans/waffenss_autumn/cos/obersturmfuhrer/playermodel.mdl"},
    {name = "Waffen SS Hauptsturmführer", model = "models/kriegsyntax/germans/waffenss_autumn/cos/hauptsturmfuhrer/playermodel.mdl"},
    {name = "Waffen SS Sturmbannführer", model = "models/kriegsyntax/germans/waffenss/cos/sturmbannfuhrer/playermodel.mdl"},
    {name = "Waffen SS Obersturmbannführer", model = "models/kriegsyntax/germans/waffenss/cos/obersturmbannfuhrer/playermodel.mdl"},
    {name = "Waffen SS Standartenführer", model = "models/kriegsyntax/germans/waffenss/cos/standartenfuhrer/playermodel.mdl"},
    {name = "Waffen SS Oberführer", model = "models/kriegsyntax/germans/waffenss/cos/oberfuhrer/playermodel.mdl"},
...
function meta:promote(div, id, new, divchange, olddiv)
  ...
  if new then
    ...
    char:setModel(rank.model)
    char:setFaction(FACTION_GERMANS)
    return true
  end
  ...
  nut.util.notify("Your rank have changed to " .. rank.name, self)
end
function meta:demote(div, rank)
  ...
  if not istable(tochange) then --Turn to civ
    nut.util.notify("You have been turned to Civilian.", self)
